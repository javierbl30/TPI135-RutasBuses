 ...
 */
@Embeddable
public class RutasBusesPK implements Serializable {
    ...
    public RutasBusesPK(String idRuta, String placaBus) {
        this.idRuta = idRuta;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RutasBusesPK)) {
            return false;
        }
        RutasBusesPK other = (RutasBusesPK) object;
    ...
    public String toString() {
        return "uesocc.edu.sv.ingenieria.tpi135_rutasbuses.entitys.RutasBusesPK[ idRuta=" + idRuta + ", placaBus=" + placaBus + " ]";
    }
